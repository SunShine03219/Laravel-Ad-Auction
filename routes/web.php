...
Route::get('a/m{id}', ['as' => 'single_ad', 'uses' => 'AdsController@singleAuction']);
...
Route::get('c{category:slug_path}', 'CategoryAuctionController@index')->where('category', '^[\w\-/]+$')->name('categoryparent');

Route::put("/api/favorite/toggle", "AdsController@toggleFavorite")
    ->middleware("auth")
